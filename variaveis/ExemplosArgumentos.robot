...
*** Variables ***
&{PESSOA}       nome=Denise Fernandes    email=denifernandes@exemplo.com.br    idade=25    sexo=feminino
...
*** Keywords ***
Uma keyword qualquer 01
    Uma subkeyword com argumentos    David Silva    bruno_silva@teste.com.br
...
Uma subkeyword com retorno
    ...
    ${MENSAGEM}    Set Variable If
    ...    ${IDADE_USUARIO}<18
    ...    Não autorizado! O usuário ${NOME_USUARIO} é menor de idade!
    ...    OK!Usuário é maior de idade!
    RETURN    ${MENSAGEM}
